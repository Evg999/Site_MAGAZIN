...
//AJAX запрос - вывод товаров в каталоге
    ...
    //формирование url
    // вырезали страку, подставили ее в переменную запрос к страничке с товарами
    // Для фильтрации по М Х дитям нужно прописать ГЕТ параметр категории полученной
    // делаем переменной
    let url = 'https://mag24-shop.ru/system/controllers/catalog/index.php';
...
function toBasket() {
    ...
    //формирование url
    let url = 'https://mag24-shop.ru/system/controllers/basket/to_basket.php';
...
function fromBasket() {
    ...
    //формирование url
    let url = 'https://mag24-shop.ru/system/controllers/basket/from_basket.php';
    let str_get = '?id=' + id;
    url = url + str_get;
...
function getSumm() {
    ...
    //формирование url
    let url = 'https://mag24-shop.ru/system/controllers/basket/get_summ.php';
