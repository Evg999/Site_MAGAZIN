...
<div class="breadcrumbs wrapper nav padding-30 text-up text-12px">
    <a class="text-12" href="index.php">Главная</a> / <a href="catalog.php">Услуги и цены</a> / <a href="catalog.php?category_id=<?= $good->getField('category_id') ?>"><?= $cat_name ?></a> / <a href="catalog.php?category_id=<?= $good->getField('category_id') ?> & type_id=<?= $good->getField('type_id') ?>"><?= $type_name ?></a> / <?= $good->title() ?>
</div>
